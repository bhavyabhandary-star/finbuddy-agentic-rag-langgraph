...
|---|---|---|
| Grounding gate | Hallucinated policy/compliance answers | Sufficiency-check node blocks Generate; low-confidence → escalate to human, exactly like production FinBuddy |
